...
MYSQL_RES* SQL::operate_Query_Result(const char *Mysql_Sentence)
{
    ...
    {
        cout << "Operate_Mysql Query Failed" << mysql_errno(this)<<":"<<mysql_error(this) << "from:" <<boost::this_thread::get_id()<<endl;
        return nullptr;
    }
}
...
int SQL::operate_select_only(const char* Mysql_Sentence)
{
    //pingtoconnect();
    int ret;
    if (0 == mysql_query(this, Mysql_Sentence))
