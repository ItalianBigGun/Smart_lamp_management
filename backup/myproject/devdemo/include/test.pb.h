...
class DevNode :
 ...
 public:
  ...
  // optional string ISEN = 3;
  bool has_isen() const;
  private:
  bool _internal_has_isen() const;
  public:
  void clear_isen();
  const std::string& isen() const;
  void set_isen(const std::string& value);
  void set_isen(std::string&& value);
  void set_isen(const char* value);
  void set_isen(const char* value, size_t size);
  std::string* mutable_isen();
  std::string* release_isen();
  void set_allocated_isen(std::string* isen);
  private:
  const std::string& _internal_isen() const;
  void _internal_set_isen(const std::string& value);
  std::string* _internal_mutable_isen();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr isen_;
  friend struct ::TableStruct_test_2eproto;
};
// ===================================================================
...
// optional string ISEN = 3;
inline bool DevNode::_internal_has_isen() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool DevNode::has_isen() const {
  return _internal_has_isen();
}
inline void DevNode::clear_isen() {
  isen_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000004u;
}
inline const std::string& DevNode::isen() const {
  // @@protoc_insertion_point(field_get:my.DevNode.ISEN)
  return _internal_isen();
}
inline void DevNode::set_isen(const std::string& value) {
  _internal_set_isen(value);
  // @@protoc_insertion_point(field_set:my.DevNode.ISEN)
}
inline std::string* DevNode::mutable_isen() {
  // @@protoc_insertion_point(field_mutable:my.DevNode.ISEN)
  return _internal_mutable_isen();
}
inline const std::string& DevNode::_internal_isen() const {
  return isen_.GetNoArena();
}
inline void DevNode::_internal_set_isen(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  isen_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void DevNode::set_isen(std::string&& value) {
  _has_bits_[0] |= 0x00000004u;
  isen_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:my.DevNode.ISEN)
}
inline void DevNode::set_isen(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000004u;
  isen_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:my.DevNode.ISEN)
}
inline void DevNode::set_isen(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000004u;
  isen_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:my.DevNode.ISEN)
}
inline std::string* DevNode::_internal_mutable_isen() {
  _has_bits_[0] |= 0x00000004u;
  return isen_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* DevNode::release_isen() {
  // @@protoc_insertion_point(field_release:my.DevNode.ISEN)
  if (!_internal_has_isen()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000004u;
  return isen_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void DevNode::set_allocated_isen(std::string* isen) {
  if (isen != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  } else {
    _has_bits_[0] &= ~0x00000004u;
  }
  isen_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), isen);
  // @@protoc_insertion_point(field_set_allocated:my.DevNode.ISEN)
}
